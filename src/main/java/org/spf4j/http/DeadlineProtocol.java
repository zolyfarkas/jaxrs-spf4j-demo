...
public class DeadlineProtocol {
  ...
  public DeadlineProtocol() {
    this(Headers.REQ_DEADLINE, Headers.REQ_TIMEOUT, 60000000000L, 600000000000L);
  }

  public DeadlineProtocol(String deadlineHeaderName, String timeoutHeaderName,
    ...
    if (deadlineStr == null) {
      ...
      if (timeoutStr == null) {
        ...
        if (parseTimeoutNanos > maxTimeoutNanos) {
            Logger.getLogger(DeadlineProtocol.class.getName())
